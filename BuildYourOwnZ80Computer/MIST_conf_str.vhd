...
entity MIST_conf_str is
    Port ( CONF_STR : out  STD_LOGIC_VECTOR (173*8-1 downto 0)
			);
end MIST_conf_str;
...
constant CONF_STRING : string := "AMSTRAD;;F,DSK,Load;F,CDT,Load;O1,Brand name,Schneider,Amstrad;O2,CRTC,1,0;O34,VGA,vram72Hz,scanlines72Hz,scandb50Hz,original;O56,Screen,color,green,THSF_orange;O7,Drive,A,B";
